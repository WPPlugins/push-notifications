...
Please note that you must have at least Developer account with Pushwoosh in order to use the plugin. The plugin is handy to send <a href="http://docs.pushwoosh.com/docs/safari-website-notifications">Safari</a>, <a href="http://docs.pushwoosh.com/docs/chrome-web-push">Chrome</a> and <a href="http://docs.pushwoosh.com/docs/firefox-web-push">Firefox</a> push notifications to your readers. You can also connect the plugin to mobile app and send push messages to your users’ mobile devices.

Please see the <a href="http://docs.pushwoosh.com/docs/wordpress-plugin">WordPress Plugin Guide</a> page on our website.
